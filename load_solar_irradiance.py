...
def load_solar_irradiance(lat, lon, time, var_names = ['daily_integral_of_surface_global_irradiance'], grid = 'nearest'):
    product_baseurl = 'https://dapds00.nci.org.au/thredds/dodsC/rv74/satellite-products/arc/der/himawari-ahi/solar/p1d/latest'
